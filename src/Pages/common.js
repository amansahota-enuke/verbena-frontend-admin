      ...
      <div className="">
        <div className="">
                ...
                <div>
                  ...
                  <div className="address w-48 ">
                    <p className="calibre-regular mid-dark-gray-color font-20">
                      D 103, Verbana Hospital,h Opposite Town Hall,h Avenue New
                      York-10001
                    </p>
                  </div>
                </div>
          ...
          <p className="text-center mb-12">
            Your appointment is booked. We have sent it to the Provider for
            Confirmation. We will send email Confirmation.
          </p>
          ...
          <div className="bg-white login-box mb-10">
            <div className="p-10 px-5 py-5 flex xl:flex-nowrap lg:flex-nowrap md:flex-wrap sm:flex-wrap flex-wrap border-b">
              ...
              <div>
                <h3 className="hepta-slab mb-1 text-xl">Dr. Rajveer Singh</h3>
                  ...
                  <div className="flex">
                    <div>
                      <h3 className="calibre-regular leading-none text-base light-dark-gray-color border-r-2 pr-2 mr-2">
                        <i className="fas fa-calendar mr-2"></i>3 June 2021
                      </h3>
                    </div>
                    <div>
          ...
          <p className="text-center mb-12">
            Thank you for sharing your Personal Health concern. Your answers
            will be reviewed before your telehealth visit.Please check and
            confirm the information below to schedule appointment
          </p>
          ...
          <div className="bg-white login-box mb-10">
            <div className="p-10 px-5 py-5 xl:flex-nowrap lg:flex-nowrap md:flex-wrap sm:flex-wrap flex-nowrap border-b">
              ...
              <div>
                <h3 className="hepta-slab mb-3 text-xl">Dr. Rajveer Singh</h3>
                <h6 className="text-base uppercase mb-3 light-gray-color">
                  Dermatologist
                </h6>
                ...
                <div className="provider-address flex xl:flex-nowrap md:flex-wrap">
                  ...
                  <div className="light-gray-color text-base">
                    79th, 308 E New York, NY 10075 United States
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="form-content xl:px-32 lg:px-32 md:px-16 sm:px-10 px-4 py-10">
              ...
              <div className="tele-health-content">
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  [Name of Patient] (Patient) hereby consent to engage in
                  Telehealth with [Therapist’s Name License] (Therapist).j
                </p>
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  I understand that Telehealth is a mode of delivering health
                  care services, including psychotherapy, via communication
                  technologies (e.g. Internet or phone) to facilitate diagnosis
                ...
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  1. I have a right to confidentiality with regard to my
                  treatment and related communications via Telehealth under the
                  same laws that protect the confidentiality of my treatment
                  information during in-person psychotherapy. The same mandatory
                  and permissive exceptions to confidentiality outlined in the
                  [Informed Consent Form or Statement of Disclosures] I received
                  from my thelapist also apply to my Telehealth services.
                </p>
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  {" "}
                  I understand that there are risks associated with
                  participating in Telehealth including, but not limited to, the
                  possibility, despite reasonable efforts and safeguards on the
                  part of my therapist, that my psychotherapy sessions and
                  transmission of my treatment information could be disrupted or
                  distorted by technical failures and/or interrupted or accessed
                  by unauthorized persons, and that the electronic storage of my
                  treatment information could be accessed by unauthorized
                  persons.
                </p>
                <p className="dd text-lg caliber-regular mb-4 dark-gray-color">
                  I understand that miscommunication between myself and my
                  therapist may occur via Telehealth.
                </p>
            ...
            <div className="form-content xl:px-32 lg:px-32 md:px-16 sm:px-10 px-4 py-10">
              ...
              <div className="grid xl:grid-cols-6 lg:grid-cols-6 md:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-6">
                ...
                <div className="col-span-6">
                  ...
                  <textarea
                    className="custom-textarea input-border-color border text-justify rounded-md py-3 px-6"
            ...
            <div className="form-content xl:px-32 lg:px-32 md:px-16 sm:px-10 px-4 py-10">
              ...
              <div>
                <div className="grid grid-cols-6 gap-6">
                  <div className="col-span-6">
                    <div className="input-label calibre-regular mb-4">
                      How was your overall telehealth experience?
                    </div>
                  ...
                  <div className="col-span-6">
                    <div className="input-label calibre-regular mb-4">
                      How would you rate the quality of the video?
                    </div>
                    <div className="feedback-flex flex">
                      <div className="feedback font-18 cursor-pointer calibre-regular light-gray-color uppercase py-2 px-5 rounded-md border mr-3 selected">
                        Excellent
                  ...
                  <div className="col-span-6">
                    <div className="input-label calibre-regular mb-4">
                      How would you rate the Verbena platform as it relates to
                      ease, convenience and overall usage.
                    </div>
                    <div className="feedback-flex flex">
                      <div className="feedback font-18 cursor-pointer calibre-regular light-gray-color uppercase py-2 px-5 rounded-md border mr-3 selected">
                        Excellent
                  ...
                  <div className="col-span-6">
                    <div className="input-label calibre-regular mb-4">
                      Did you had enough time with your physician?
                    </div>
                    <div className="feedback-flex flex">
                      <div className="feedback font-18 cursor-pointer calibre-regular light-gray-color uppercase py-2 px-5 rounded-md border mr-3 selected">
                        Yes
                  ...
                  <div className="col-span-6">
                    <div className="input-label calibre-regular mb-4">
                      Would you continue to use telehealth services in the
                      future?
                    </div>
                    <div className="feedback-flex flex">
                      <div className="feedback font-18 cursor-pointer calibre-regular light-gray-color uppercase py-2 px-5 rounded-md border mr-3 selected">
        ...
        <div className="container mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-12 gap-6">
            <div className="col-span-12">
              ...
              <h4 className="hepta-slab mb-4 heading-toggle-1 cursor-pointer">
                Questionnaire Details{" "}
              ...
              <div className="bg-white rounded-md mb-6 tab-1">
                <div className="health-info border-b-1">
                  ...
                  <p className="px-5 py-2 text-2xl calibre-bold text-2x">Yes</p>
                </div>
                <div className="health-info border-b-1">
                  <h3 className="text-xl dark-color px-5 py-2 calibre-regular">
                    Do you have Heart Disease?
                  </h3>
                  <p className="text-2xl px-5 py-2 calibre-bold text-2x">No</p>
                </div>
                <div className="health-info border-b-1">
                  <h3 className="text-xl dark-color px-5 py-2 calibre-regular">
                    Do you suffer from Migraines?
                  </h3>
                  <p className="text-2xl px-5 py-2 calibre-bold text-2x">Yes</p>
                </div>
                <div className="health-info border-b-1">
                  <h3 className="text-xl dark-color px-5 py-2 calibre-regular">
                    Did you suffer from any kind of stroke in your body?
                  </h3>
                  <p className="text-2xl px-5 py-2 calibre-bold text-2x">No</p>
                </div>
                <div className="health-info border-b-1">
              ...
              <h4 className="hepta-slab mb-4 heading-toggle-2 cursor-pointer">
                Basic Health Questionner{" "}
                <span className="p-2 primary-bg-color rounded-2xl text-white font-14">
                  25 Sep 2019
                </span>
                <span className="float-right">
                  <i className="fas fa-chevron-down"></i>
              ...
              <div className="bg-white rounded-md mb-6">
                  ...
                  <div className="grid grid-cols-12 gap-6 items-center">
                    <div className="col-span-2">
                      <input
                        ...
                        className="custom-input w-full border rounded input-border"
                      />
                    </div>
                    <div className="col-span-2">
                      <div className="relative">
                ...
                <div className="content-footer p-6">
                  <div className="flex justify-center">
                    <a href="#">
                      <i className="fas fa-plus-circle primary-text-color align-middle mr-2"></i>
                      ADD MORE TEST
                    </a>
                  </div>
                </div>
                ...
                <div className="content">
                    ...
                    <div className="flex justify-between items-center">
                      <div className="">
                        <h2 className="font-16 m-0 calibre-regular">
                          <i className="fas fa-file mr-3"></i>CT Scan
                        </h2>
                      </div>
                      <div className="relative">
                        <button
                  ...
                  <div class="p-3 border-b-1 mb-3">
                    <div className="flex justify-between items-center">
                      <div className="">
                        <h2 className="font-16 m-0 calibre-regular">
                          <i className="fas fa-file mr-3"></i>Ultra Sound
                        </h2>
                      </div>
                      <div className="relative">
                        <button
                  ...
                  <div class="p-3 border-b-1 mb-3">
                    <div className="flex justify-between items-center">
                      <div className="">
                        <h2 className="font-16 m-0 calibre-regular">
                          <i className="fas fa-file mr-3"></i>Blood Test
                        </h2>
                      </div>
                      <div className="relative">
                        <button
              ...
              <div className="bg-white rounded-md mb-6">
                ...
                <div className="content-footer p-6">
                  <div className="flex justify-center">
                    <a href="#">
                      <i className="fas fa-plus-circle primary-text-color align-middle mr-2 uppercase"></i>
                      ADD MORE MEDICINE
                    </a>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-center">
                <button
                  type="button"
                  className="btn-login calibre-bold font-18 uppercase primary-dim-bg-color text-white mr-3"
                >
                  Cancel
                </button>
                <button
          ...
          <div className="grid grid-cols-6 gap-6">
            <div className="col-span-4">
              ...
              <h4 className="hepta-slab mb-4">Basic Health Information</h4>
            ...
            <div className="col-span-2">
              <h4 className="hepta-slab mb-4">Patients Details</h4>
              <div className="bg-white rounded-md mb-3 px-4 py-4">
                <div className="flex flex-wrap justify-between">
                  <div>
                    <div className="flex xl:flex-nowrap lg:flex-nowrap md:flex-wrap sm:flex-nowrap">
