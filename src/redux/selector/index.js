export default {
  ...
  deleteProvider: (state) => state.provider.isProviderDeleted,
  providerId: (state) => state.provider.id,
  //Payment Reducer
  ...
  newsLetterSubscriptions: (state) =>
    state.newslettersubscribers.subscribersList,
};
