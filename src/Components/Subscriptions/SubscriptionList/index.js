                ...
                {paymentSatus === statusConstants.PENDING ? (
                  ...
                  SubscriptionList.map((subscription) => (
                    <tr key={subscription.id}>
                      ...
                      <td className="px-6 dark-gray-color py-4 whitespace-nowrap text-center font-18">
                        {subscription.patient
                          ? `${parseName(
                            ...
                            )} ${parseName(subscription.patient.last_name)}`
                          : `${parseName(
                      ...
                      <td className="px-6 dark-gray-color py-4 whitespace-nowrap text-center font-18">
                        {subscription.patient
                          ? subscription.patient.mobile_number
                          : subscription.provider.mobile_number}
                      </td>
                      <td className="px-6 dark-gray-color py-4 whitespace-nowrap text-center font-18">
                        {subscription.patient
                      ...
                      <td className="px-6 dark-gray-color py-4 whitespace-nowrap text-center font-18">
                        {`${moment(
                          Number(
                            JSON.parse(subscription.res_body)
                              .current_period_end + "000"
                          )
                        ).format("D MMMM YYYY")}`}
                      </td>
                    </tr>
