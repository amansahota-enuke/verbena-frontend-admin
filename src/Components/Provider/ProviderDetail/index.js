...
import { ButtonLoader, FullWidthContainer } from "../../";
                        ...
                        <div className="col-span-6 sm:col-span-3">
                            <div className="bg-white p-8 rounded-lg mb-8">
                                ...
                                <p className="about-content mid-dark-gray-color text-base mb-2">
                                    ...
                                    mollit anim id est laborum.hExcepteur sint
                                ...
                                <p className="about-content mid-dark-gray-color text-base mb-2">
                                    ...
                                    fugiat quo voluptas nulla pariatu. qui
                                    dolorem ipsum quia dolor sit amet.h
                                </p>
                            </div>
                        </div>
                                    ...
                                    <div>
                                        <div className="testimonial-content relative">
                                            ...
                                            <p className="calibre-regular text-lg mid-dark-gray-color mb-8">
                                                Visited for acne advanced facial
                                                and full body laser hair
                                                removal. I have been visiting
                                                Dr. Rajveer Singh for last 4
                                                years for various skin problems.
                                                I took few advanced facials with
                                                Dr. Rahveer Singh before my
                                                wedding 2 years back. I was
                                                extremely happy and satisfied
                                                with results. I am happy that I
                                                did not spend money on parlour/
                                                salon facials. 1 year back I
                                                started taking full body laser
                                                hair removal and again results
                                                were to my expectations. Now I
                                                hardly go through painful
                                                waxing.
                                            </p>
