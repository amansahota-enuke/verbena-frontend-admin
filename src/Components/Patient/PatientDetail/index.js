                        ...
                        <div className="flex xl:flex-nowrap lg:flex-nowrap md:flex-wrap sm:flex-nowrap">
                            ...
                            <div>
                                ...
                                <div className="flex flex-nowrap mb-1">
                                    <div className="font-18 calibre-regular light-dark-gray-color mr-3 pr-3 leading-tight border-r-2">
                                        {selectedPatient.gender === "M"
                                            ? "Male"
                                            : "Female"}
                                    </div>
                                    <div className="font-18 calibre-regular light-dark-gray-color leading-tight">
                                        {selectedPatient.dob &&
                                            getAge(selectedPatient.dob)}
                                    </div>
                                </div>
                                <div className="flex flex-nowrap mb-1">
                                    <div className="font-18 calibre-regular light-dark-gray-color mr-3 pr-3 leading-tight">
